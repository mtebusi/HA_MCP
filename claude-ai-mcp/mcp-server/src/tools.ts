...
export function setupTools(server: McpServer, bridge: HomeAssistantBridge) {
  ...
  server.registerTool(
    ...
    async (args: { entity_id: string }) => {
      ...
      await bridge.callService(domain, 'turn_on', args.entity_id);
      return {
        content: [{
          type: 'text' as const,
  ...
  server.registerTool(
    ...
    async (args: { entity_id: string }) => {
      const [domain] = args.entity_id.split('.');
      await bridge.callService(domain, 'turn_off', args.entity_id);
      return {
        content: [{
          type: 'text' as const,
  ...
  server.registerTool(
    ...
    async (args: { entity_id: string }) => {
      const [domain] = args.entity_id.split('.');
      await bridge.callService(domain, 'toggle', args.entity_id);
      return {
        content: [{
          type: 'text' as const,
  ...
  server.registerTool(
    ...
    async (args: { domain: string; service: string; entity_id?: string; data?: Record<string, any> }) => {
      await bridge.callService(args.domain, args.service, args.entity_id, args.data);
      return {
        content: [{
          type: 'text' as const,
  ...
  server.registerTool(
    ...
    async (args: { entity_id: string; brightness: number }) => {
      await bridge.callService('light', 'turn_on', args.entity_id, {
  ...
  server.registerTool(
    ...
    async (args: { entity_id: string; temperature: number }) => {
      await bridge.callService('climate', 'set_temperature', args.entity_id, {
  ...
  server.registerTool(
    ...
    async (args: { entity_id: string }) => {
      await bridge.callService('automation', 'trigger', args.entity_id);
      return {
        content: [{
          type: 'text' as const,
  ...
  server.registerTool(
    ...
    async (args: { message: string; title?: string; target?: string }) => {
      ...
      await bridge.callService('notify', service, undefined, {
